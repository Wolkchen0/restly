            ...
            <div className="page-content fade-in">
                ...
                <div className="kpi-grid">
                    <div className="kpi-card">
                        ...
                        <div className="kpi-value" style={{ color: "var(--yellow)" }}>18m 30s</div>
                    </div>
                    <div className="kpi-card">
                        <div className="kpi-label">Longest Ticket</div>
                        <div className="kpi-value" style={{ color: "var(--red)" }}>28m 05s</div>
                    </div>
                    <div className="kpi-card">
                        <div className="kpi-label">Open Tickets</div>
                        <div className="kpi-value" style={{ color: "var(--text-primary)" }}>14</div>
                    </div>
                    <div className="kpi-card">
                        <div className="kpi-label">Throughput / hr</div>
                        <div className="kpi-value" style={{ color: "var(--green)" }}>42 plates</div>
                    </div>
                </div>
